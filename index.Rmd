...
```{r}
#se extraen los datos de los países centroamericanos con esperanza de vida mayor o igual a 74 años
mayor_igual_74_anos = world[world$name_long == "Nicaragua" |
                       world$name_long == "Costa Rica" |
                       world$name_long == "Panama"
                       , ]
# Se formatea la tabla con el nuevo data frame
kable(
  mayor_igual_74_anos[, c("name_long","continent","pop","lifeExp","gdpPercap"), drop = TRUE], 
  col.names=c("País","Continente","Población","Esperanza de vida","Renta per cápita"),  
  caption="Datos demográficos de los países de Centroamérica"
) %>%
kable_styling()

#se genera el mapa de coropletas
plot(mayor_igual_74_anos["lifeExp"], main=" Países de Centroamérica con esperanza de vida mayor o igual a 74 años")
```